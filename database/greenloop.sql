...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2026 at 09:34 AM
...
CREATE TABLE `products` (
  ...
  `eco_rating` decimal(3,1) NOT NULL,
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`delivery_agent_id`) REFERENCES `delivery_agents` (`agent_id`);
